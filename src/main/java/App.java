...
public class App {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        mainWindow.setSize(1920, 1080); // TODO edit this if it's too big.
        ...
        ImageIcon boardImg = new ImageIcon("path_to_board_img");
//        ImageIcon boardImg = new ImageIcon("C:\\Users\\Joshua\\Desktop\\school\\UToronto\\year2\\csc207\\monopoly_assets\\Recreated_by_me\\misc\\board.jpg");
        JLabel scaledBoardImg = new JLabel(new ImageIcon(boardImg.getImage().getScaledInstance(900, 900, Image.SCALE_DEFAULT)));
        ...
        GridLayout horizontalSplit = new GridLayout(1,2);
        bottomBox.setLayout(horizontalSplit);
        JPanel inventoryButtons = new JPanel();
        bottomBox.add(inventoryButtons);
        ViewInventoryPresenter buttonsInv = new ViewInventoryPresenter(inventoryButtons);
        Board example = FactoryBoard.boardMaker("src/main/resources/Data/property_csvs/Color Properties Monopoly.csv",
        ...
        Player player1 = new Player("p1", "icon", 1500, example);
        player1.addProperty(example.getPropertyTiles().get(0));
        ...
        buttonsInv.showInventoryButtons(InventoryData.creator(playerList));
        /*
        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
